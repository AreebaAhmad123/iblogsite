    ...
    <>
      ...
      >
        <div className="w-full max-w-[1400px] mx-auto px-[5vw] flex items-center justify-between h-full">
          ...
          <div className="hidden md:flex flex-1 justify-center space-x-6 items-center flex-nowrap">
            ...
            >
              ...
              <AnimatePresence>
                {showCategoryDropdown && (
                  <motion.div
                    className="absolute left-0 mt-2 bg-white rounded shadow-lg z-50 overflow-x-auto"
                    style={{ minWidth: `${columns * 14}rem` }}
                    variants={dropdownAnimation}
                    initial="initial"
                    animate="animate"
                    exit="exit"
                  >
                    <div className={`grid grid-flow-row grid-cols-${columns} gap-0`}>
                      {categories.map((cat, index) => (
                        ...
                        >
                          <Link
                            ...
                            className="block px-4 w-56 break-words whitespace-pre-line text-gray-700 categoryDropdownHover categoryDropdownItem capitalize"
